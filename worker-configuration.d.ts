/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 251c60d303bbab92ccbf735bab4a5c45)
// Runtime types generated with workerd@1.20260424.1 2026-04-18 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PUBLIC_SUPABASE_URL: string;
		PUBLIC_SUPABASE_PUBLISHABLE_KEY: string;
		/** Service Role Key（RLS バイパス用 / サーバーサイドのみ） */
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_SUPABASE_URL" | "PUBLIC_SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
